# Testing Guide for whrkflow

This guide will help you test the whrkflow HR Management Platform APIs.
...
```
NAME                  IMAGE                    STATUS
whrkflow-postgres     postgres:15-alpine       Up
whrkflow-pgadmin      dpage/pgadmin4:latest    Up
```
...
```
Started WhrkflowApplication in X.XXX seconds
```
...
# Default credentials:
# - Database: whrkflow_db
# - Username: whrkflow_user
# - Password: whrkflow_pass
```
...
4. **Use pgAdmin** (http://localhost:5050) for database inspection
   - Login: admin@whrkflow.com / admin123
