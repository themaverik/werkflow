...
VALUES
    (1, 'EMP001', 'John', 'Doe', 'john.doe@whrkflow.com', '+1234567890', '1985-05-15', '2020-01-15',
     'Engineering Manager', 'ACTIVE', 120000.00, '123 Main St, City, State', 1, NULL, CURRENT_TIMESTAMP, 'system', 0),

    (2, 'EMP002', 'Jane', 'Smith', 'jane.smith@whrkflow.com', '+1234567891', '1990-08-22', '2020-03-01',
     'Senior Backend Developer', 'ACTIVE', 95000.00, '456 Oak Ave, City, State', 6, 1, CURRENT_TIMESTAMP, 'system', 0),

    (3, 'EMP003', 'Mike', 'Johnson', 'mike.johnson@whrkflow.com', '+1234567892', '1988-11-10', '2020-06-15',
     'Senior Frontend Developer', 'ACTIVE', 90000.00, '789 Pine Rd, City, State', 7, 1, CURRENT_TIMESTAMP, 'system', 0),

    (4, 'EMP004', 'Sarah', 'Williams', 'sarah.williams@whrkflow.com', '+1234567893', '1992-03-25', '2021-01-20',
     'HR Manager', 'ACTIVE', 85000.00, '321 Elm St, City, State', 2, NULL, CURRENT_TIMESTAMP, 'system', 0),

    (5, 'EMP005', 'Robert', 'Brown', 'robert.brown@whrkflow.com', '+1234567894', '1987-07-18', '2021-04-10',
     'Finance Manager', 'ACTIVE', 95000.00, '654 Maple Dr, City, State', 3, NULL, CURRENT_TIMESTAMP, 'system', 0),

    (6, 'EMP006', 'Emily', 'Davis', 'emily.davis@whrkflow.com', '+1234567895', '1993-12-05', '2021-08-01',
     'Backend Developer', 'ACTIVE', 75000.00, '987 Birch Ln, City, State', 6, 2, CURRENT_TIMESTAMP, 'system', 0),

    (7, 'EMP007', 'David', 'Wilson', 'david.wilson@whrkflow.com', '+1234567896', '1991-09-14', '2022-02-15',
     'Frontend Developer', 'ACTIVE', 72000.00, '147 Cedar Way, City, State', 7, 3, CURRENT_TIMESTAMP, 'system', 0),

    (8, 'EMP008', 'Lisa', 'Martinez', 'lisa.martinez@whrkflow.com', '+1234567897', '1994-04-30', '2022-05-20',
