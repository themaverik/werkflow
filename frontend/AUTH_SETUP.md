...
This guide explains how to set up Keycloak authentication for the Whrkflow frontend.
...
2. **Whrkflow realm** created in Keycloak
...
3. Select the `whrkflow` realm
4. Go to **Clients** → **Create client**

### 2. Client Configuration

**General Settings:**
- **Client ID**: `whrkflow-frontend`
- **Name**: `Whrkflow Frontend Application`
- **Description**: `Next.js frontend for Whrkflow`
...
1. Go to **Clients** → `whrkflow-frontend` → **Credentials** tab
2. Copy the **Client secret** value
3. Save it for the `.env.local` file

### 4. Configure Client Scopes

1. Go to **Clients** → `whrkflow-frontend` → **Client scopes** tab
...
# Keycloak (Production)
KEYCLOAK_CLIENT_ID=whrkflow-frontend-prod
KEYCLOAK_CLIENT_SECRET=<production-secret>
KEYCLOAK_ISSUER=https://auth.whrkflow.com/realms/whrkflow
```
