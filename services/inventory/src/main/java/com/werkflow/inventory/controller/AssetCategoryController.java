...
import com.werkflow.inventory.dto.AssetCategoryRequestDto;
import com.werkflow.inventory.dto.AssetCategoryResponseDto;
...
public class AssetCategoryController {
    ...
    public ResponseEntity<AssetCategoryResponseDto> createCategory(@Valid @RequestBody AssetCategoryRequestDto requestDto) {
        AssetCategory category = AssetCategory.builder()
            ...
            .primaryCustodianDeptId(requestDto.getPrimaryCustodianDeptId())
            .build();
