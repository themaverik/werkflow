...
import com.werkflow.inventory.dto.AssetDefinitionRequestDto;
import com.werkflow.inventory.dto.AssetDefinitionResponseDto;
...
public class AssetDefinitionController {
    ...
    public ResponseEntity<List<AssetDefinitionResponseDto>> getAllDefinitions() {
        List<AssetDefinition> definitions = definitionService.getAllDefinitions();
